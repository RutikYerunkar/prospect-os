...
class TestCriterion4BLiveHonestDegradeOnUnusableCredential:
    """4B, V2-I-b final state: the structural refusal is no longer on the
    real dispatch path (see `docs/PROGRESS.md`'s V2-I-b entry — removed only
    after the full CI verification checklist passed, PR #23). This test's
    fabricated Gmail connection uses a placeholder ciphertext
